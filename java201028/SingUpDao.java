...
public class SingUpDao {
	private ArrayList<SingUp> singups;
	private int no = 1;

	public SingUpDao() {
		singups = new ArrayList<>();
...
//
//		for (int i = 0; i < singups.size(); i++) {
//			Reply reply = singups.get(i);
//
...
//	public void insertSingUp(SingUp s) {
//		s.setId(no);
//		no++;
//		singups.add(s);
//	}

	public ArrayList<SingUp> getSingUp() {
		return singups;
	}
}
