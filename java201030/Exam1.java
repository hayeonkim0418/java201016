...
//					break;
			...
			if(s.equals("signin")) {
				...
				ArrayList<Member> signInMember;
				String targetId = sc.next();
				signInMember = memberDao.getSignInById(targetId);
	...
	private static void printMember(ArrayList<Member> MemberList) {
		for (int i = 0; i < MemberList.size(); i++) {
			Member members = MemberList.get(i);

			System.out.println("ID: " + members.getLoginId());
			System.out.println("PW: " + members.getLoginPw());
			System.out.println("NICKNAME: " + members.getNickname());
